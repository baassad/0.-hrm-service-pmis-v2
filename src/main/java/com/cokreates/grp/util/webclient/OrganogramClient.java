...
public interface OrganogramClient {
    ...
    @RequestMapping(method= RequestMethod.POST, value="/office-unit-post/v1/get-by-officeunit-and-post-oid", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ResponseModel<OfficeUnitPostDTO> getOfficeUnitPostByOfficeUnitAndPostFromOrganogram(ServiceRequestDTO<OfficeUnitAndPostOidHolderRequestBodyDTO> requestDTO);
